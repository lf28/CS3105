...
4. Outline how rejection sampling can be used to compute $P(D_1=3| S =9)$
...
* outline how Gibbs sampling can be used to infer the probability that the switching point is right in the middle of the tosses
"""
...
manifest_format = "2.0"
project_hash = "a62730379d3e35422282591e661b9d0cf28a3179"
